...
class tension extends React.Component {
  constructor(props) {
    ...
    this.state = {socialImage: social4}
  }

  componentDidUpdate() {
    if (this.props.social === 0 && this.state.socialImage !== this.social4) {
      this.setState({ socialImage: this.social4 });
    } else if (this.props.social === 1 && this.state.socialImage !== this.social3) {
      this.setState({ socialImage: this.social3 });
    } else if (this.props.social === 2 && this.state.socialImage !== this.social2) {
      this.setState({ socialImage: this.social2 });
    } else if (this.props.social >= 3 && this.state.socialImage !== this.social1) {
